...
const fallbackStock = {
  ...
  'mate-torpedo-campero': { stock: 1, activo: true, precio: 48000 },
  'mate-torpedo-roma-calado': { stock: 1, activo: true, precio: 82000 },
  'bombillon-pico-de-rey': { stock: 2, activo: true, precio: 31000 },
  'canasta-matera-cuero-lisa': { stock: 1, activo: true, precio: 45000 },
  'mate-camionero-algarrobo': { stock: 2, activo: true, precio: 23500 },
};
...
const products = {
  ...
  */
  ...
  'mate-torpedo-campero': {
    name: 'Mate Torpedo Campero',
    categoryLabel: 'Mate · Torpedo',
    price: 48000,
    skus: ['mate-torpedo-campero'],
    qtyInputId: 'mateTorpedoCamperoQty',
    buttonSelector: '[data-product-id="mate-torpedo-campero"]',
    stockMessageId: 'mateTorpedoCamperoStockMessage',
    detailPriceIds: ['mateTorpedoCamperoPrice'],
    catalogPriceId: 'catalogPriceMateTorpedoCampero',
    cardStockSelector: '[data-card-stock="mate-torpedo-campero"]',
    getOptions: () => ({}),
    getQty: () => Number(document.getElementById('mateTorpedoCamperoQty')?.value || 1),
    getSku: () => 'mate-torpedo-campero',
  },
  'mate-torpedo-roma-calado': {
    name: 'Mate Torpedo Roma Calado',
    categoryLabel: 'Mate · Torpedo',
    price: 82000,
    skus: ['mate-torpedo-roma-calado'],
    qtyInputId: 'mateTorpedoRomaCaladoQty',
    buttonSelector: '[data-product-id="mate-torpedo-roma-calado"]',
    stockMessageId: 'mateTorpedoRomaCaladoStockMessage',
    detailPriceIds: ['mateTorpedoRomaCaladoPrice'],
    catalogPriceId: 'catalogPriceMateTorpedoRomaCalado',
    cardStockSelector: '[data-card-stock="mate-torpedo-roma-calado"]',
    getOptions: () => ({}),
    getQty: () => Number(document.getElementById('mateTorpedoRomaCaladoQty')?.value || 1),
    getSku: () => 'mate-torpedo-roma-calado',
  },
  'bombillon-pico-de-rey': {
    name: 'Bombillón Pico de Rey',
    categoryLabel: 'Bombillón',
    price: 31000,
    skus: ['bombillon-pico-de-rey'],
    qtyInputId: 'bombillonPicoReyQty',
    buttonSelector: '[data-product-id="bombillon-pico-de-rey"]',
    stockMessageId: 'bombillonPicoReyStockMessage',
    detailPriceIds: ['bombillonPicoReyPrice'],
    catalogPriceId: 'catalogPriceBombillonPicoRey',
    cardStockSelector: '[data-card-stock="bombillon-pico-de-rey"]',
    getOptions: () => ({}),
    getQty: () => Number(document.getElementById('bombillonPicoReyQty')?.value || 1),
    getSku: () => 'bombillon-pico-de-rey',
  },
  'canasta-matera-cuero-lisa': {
    name: 'Canasta Matera de Cuero Lisa',
    categoryLabel: 'Matera',
    price: 45000,
    skus: ['canasta-matera-cuero-lisa'],
    qtyInputId: 'canastaMateraLisaQty',
    buttonSelector: '[data-product-id="canasta-matera-cuero-lisa"]',
    stockMessageId: 'canastaMateraLisaStockMessage',
    detailPriceIds: ['canastaMateraLisaPrice'],
    catalogPriceId: 'catalogPriceCanastaMateraLisa',
    cardStockSelector: '[data-card-stock="canasta-matera-cuero-lisa"]',
    getOptions: () => ({}),
    getQty: () => Number(document.getElementById('canastaMateraLisaQty')?.value || 1),
    getSku: () => 'canasta-matera-cuero-lisa',
  },
  'mate-camionero-algarrobo': {
    name: 'Mate Camionero de Algarrobo',
    categoryLabel: 'Mate · Camionero',
    price: 23500,
    skus: ['mate-camionero-algarrobo'],
    qtyInputId: 'mateCamioneroAlgarroboQty',
    buttonSelector: '[data-product-id="mate-camionero-algarrobo"]',
    stockMessageId: 'mateCamioneroAlgarroboStockMessage',
    detailPriceIds: ['mateCamioneroAlgarroboPrice'],
    catalogPriceId: 'catalogPriceMateCamioneroAlgarrobo',
    cardStockSelector: '[data-card-stock="mate-camionero-algarrobo"]',
    getOptions: () => ({}),
    getQty: () => Number(document.getElementById('mateCamioneroAlgarroboQty')?.value || 1),
    getSku: () => 'mate-camionero-algarrobo',
  }
};
